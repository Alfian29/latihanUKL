...
<!----webfonts--->
<link href='<?=base_url()?>assets/http://fonts.googleapis.com/css?family=Roboto:400,100,300,500,700,900' rel='stylesheet' type='text/css'>
<!---//webfonts--->  
<!-- Nav CSS -->
<link href="<?=base_url()?>assets/css/custom.css" rel="stylesheet">
<!-- Metis Menu Plugin JavaScript -->
<script src="j<?=base_url()?>assets/css/metisMenu.min.js"></script>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?=base_url()?>assets/grids.html">Grid System</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
		       ...
		       <div class="activity_box">
		        <div class="scrollbar" id="style-2">
                   <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?=base_url()?>assets/images/5.png' class="img-responsive" alt=""/></div>
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?=base_url()?>assets/images/3.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?=base_url()?>assets/images/1.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row1">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?=base_url()?>assets/images/4.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
